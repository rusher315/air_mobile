package com.util
{
	...
	public class ZooProfile extends Sprite {	

		protected const WIDTH : uint = 150;
		protected const HEIGHT : uint = 200;
		protected const TEXT_HEIGHT : uint = 70;
		 ...
		 */
		public function ZooProfile() : void {
			...
			style.setStyle('xml', {fontSize:'15px', fontFamily:'_sans', leading:'-2px'});
			...
			rectangle = new Rectangle(WIDTH - 1, 0, 1, HEIGHT - TEXT_HEIGHT);			
		...
		private function init(e : Event) : void {
			...
			graph = new BitmapData(WIDTH, HEIGHT - TEXT_HEIGHT, false, colors.bg);
			graphics.beginBitmapFill(graph, new Matrix(1, 0, 0, 1, 0, TEXT_HEIGHT));
			graphics.drawRect(0, TEXT_HEIGHT, WIDTH, HEIGHT - TEXT_HEIGHT);
...
class Colors {
	...
	public var bg : uint = 0xEEEEEE;
	public var fps : uint = 0xFF9900;
	public var ms : uint = 0x006600;
	public var mem : uint = 0x3300FF;
	public var memmax : uint = 0xCC0066;
//	public var bg : uint = 0xEEEEEE;
//	public var fps : uint = 0xFF9900;
//	public var ms : uint = 0x006600;
//	public var mem : uint = 0x3300FF;
